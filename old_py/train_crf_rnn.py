...
from model_crf_rnn import *
from data_reader_general import data_reader, data_generator
from configs.config_crf_rnn import config
import pickle
import numpy as np
import codecs
import copy
...
def train():
    ...
    for e_ in range(config.epoch):
        ...
        #Record the result
        with open(config.log_path+'crf_rnn_log.txt', 'a') as f:
        ...
        if valid_acc > best_acc: 
            ...
            torch.save(best_model, config.model_path+'crf_rnn_model.pt')
