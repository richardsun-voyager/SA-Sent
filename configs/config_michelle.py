...
class Config():
    def __init__(self):
        ...
        self.embed_path = "data/michelle/vocab/local_emb.pkl"
        self.data_path = "data/michelle/"
        self.train_path = "data/michelle/train.pkl"
        self.valid_path = "data/michelle/valid.pkl"
        self.test_path = "data/michelle/test.pkl"
        self.dic_path = "data/michelle/vocab/dict.pkl"
